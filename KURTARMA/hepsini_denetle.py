...
def d10_ad_kurali_sinavi(kok, yaz):
    ...
    Bu kural hedef disi SAYISINI belirliyor. Bozulursa yoneticiye giden tabloda
...
def d11_siparis_dizileri(kok, yaz):
    """Yoneticiye/tedarikciye giden xlsx ile panelin SU ANKI dizileri ayni mi.
...
def d12_kanitsiz_kosulsuz(kok, yaz):
    ...
    kosulsuz siparis hukmu verilmis. "Kosulsuz" sozcugu yoneticiye "bunda
    ...
    if supheli:
        bulgu(u'KOSULSUZ yazili ama kaniti eksik',
              u'\n      '.join(supheli) +
              u'\n      "Kosulsuz" yoneticiye "tartisilacak bir sey yok" diye okunur. '
