...
def ASAMALAR(ayar):
    ...
    L = [
        ...
        dict(kod='I', ad=u'KIMLIK DOGRULAMA - yoneticiye giden iddialar bagimsiz sinanir',
...
def on_kontrol(kok, ayar, yaz):
    ...
    satir(u'Kraken araci (../SRC/WSL/130_KRAKEN_ARAC.sh)', bool(ayar.get('karac')),
...
# ===========================================================================
def kraken_bul(kok):
    aday = os.path.abspath(os.path.join(kok, '..', 'SRC', 'WSL', '130_KRAKEN_ARAC.sh'))
    if os.path.exists(aday):
        return aday, u''
