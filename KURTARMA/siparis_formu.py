...
MicRhoBooster_PCR_Paneli_2026-08-02_TESLIM.xlsx dosyasinin "2 Panel" sayfasini
...
Kosum:
    python KURTARMA/siparis_formu.py --kok .
Cikti:
...
def main():
    ...
    with io.open(my, 'w', encoding='utf-8', newline='') as fh:
        ...
        fh.write(u'> **Excel dosyasından kopyalamayın.** '
                 u'`MicRhoBooster_PCR_Paneli_2026-08-02_TESLIM.xlsx` içindeki '
