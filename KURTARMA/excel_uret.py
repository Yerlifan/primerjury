...
Kosum:
    python KURTARMA/excel_uret.py --kok .
Cikti:
    MicRhoBooster_PANEL_<tarih>.xlsx
"""
...
def main():
    ...
    metin = [
        ('MicRhoBooster qPCR paneli - tek dogru dosya', 16, True),
    ...
    cy = T('MicRhoBooster_PANEL_%s.xlsx' % time.strftime('%Y%m%d'))
    wb.save(cy)
    print('yazildi: %s' % cy)
