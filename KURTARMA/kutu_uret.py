...
Kosum:
    python KURTARMA/kutu_uret.py --kok . --yalniz-kalibrasyon
    python KURTARMA/kutu_uret.py --kok . --kapsam 0.95
"""
...
def main():
    ...
    ek += [os.path.join(kok, os.pardir, 'ALI', 'SONUCLAR', 'fastq files'),
           os.path.join(kok, os.pardir, 'ALI', 'SONUCLAR'),
    ...
    yaz(u'    KAPSAMLI_ARAMA.bat -> secenek 6 (konsensus), sonra tek tus G asamasi')
    yaz(u'=' * 78)
    return 0
