# -*- coding: utf-8 -*-
"""KIMLIK DOGRULAMA TURU - yoneticiye gonderilen kimlik iddialarini BAGIMSIZ olarak sinar.
...
# -------------------------------------------------------------------------
# kimlik_dogrulama.py — yoneticiye gonderilen kimlik iddialarini dis referans
...
IDDIALAR = [
 ...
 dict(no=3, oncelik=1, tip='dagilim', beklenen_cins='Petriella',
      ...
      # Toplam 12 kutu. Metin artik olculen sayiyi yaziyor; yoneticiye giden
...
def savunulabilir_duzey(isabetler, lokus='SSU'):
    ...
    return dict(duzey='AILE ve USTU (ad VERILEMEZ)',
                ...
                gerekce=u'kimlik %%%s cins esiginin (%%%s) bile ALTINDA. Bu bir KIMLIK '
                        u'DEGILDIR, yalnizca en yakin referans kayittir; yoneticiye '
...
def calistir(kok, yalniz, sifirla, vtb_ust, nt_kip='oto', nt_yukle_yolu=None,
    ...
    yaz('=' * 78)
    yaz('  KIMLIK DOGRULAMA TURU - yoneticiye gonderilen iddialar bagimsiz sinaniyor')
...
#
# DUZELTILMELI satirlari raporun BASINDA durur: yoneticiye gidecek olan onlardir.
# ---------------------------------------------------------------------------
def raporla(CIKTI, sonuc, var, yaz):
    ...
    with open(r, 'w', encoding='utf-8') as fh:
        ...
        for etiket, baslik in (('DUZELTILMELI', u'## Duzeltilmesi gerekenler (yoneticiye gidecek)'),
