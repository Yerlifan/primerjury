...
Kosum:
    python KURTARMA/esik_yeniden.py --kok .
Cikti:
...
def main():
    ...
    # ureten betik projede YOK. capraz_kontrol.py yalnizca aritmetigi
    ...
    #
    # Bu bir eksiktir ve raporda oyle gecer: yoneticiye giden bir karar
