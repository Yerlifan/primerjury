...
Sebep aritmetik degil, UYELIK KAYNAGI idi:
  ...
  cok_lokus.py,        -> hedefler.hedef_baglami() : steps/hedefler.tsv
...
BU MODUL panelin yolunu TEK dogru yol kabul eder ve onu ICE AKTARIR:
  ...
  - ASIL OLCUM        : screening.numune.Numune.olc  (yeniden yazilmadi)
...
def _kur(kok):
    ...
    from screening import numune as N, hedefler as H, yapilandirma as C, motor
