...
def main():
    ...
    with open(hedef, "w") as fh:
        for k in a.kume:
            if "=" not in k:
                print(f"HATA: --kume bicimi 'ad=/yol' olmali, gelen: {k}")
                sys.exit(1)
            ad, yol = k.split("=", 1)
