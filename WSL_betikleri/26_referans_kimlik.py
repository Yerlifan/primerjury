...
# -*- coding: utf-8 -*-
"""
26_referans_kimlik.py
REFERANS TABANLI PRIMERLERIN NUMUNEDE NEYI COGALTTIGINI OLCER.

15_referans_tasarim.py, numunede karsilanamayan hedefler icin referans
...
olcum (22_hedef_kimlik.py) numunedeki kutularin Kraken2 etiketleriyle
...
Kullanim:
  python3 26_referans_kimlik.py --referans primer_referans/primer_referans.tsv \
