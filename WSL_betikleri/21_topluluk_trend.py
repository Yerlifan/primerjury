...
the colleague's klasor adlarinda F1 ve F2 yer degistirmisti.

Kullanim:
  python3 21_topluluk_trend.py --bracken "bracken results" \
...
def get_args():
    ...
    p.add_argument("--rutbe", default=None,
                   help="25_bolluk_rutbe.py'nin cikti klasoru; verilirse "
...
def main():
    ...
    satirlar = [
        ...
        ("0b", "Bracken ÇSRCŞTIRILMADI. Bracken üst rütbede kalan okumaları "
    ...
    for duzey, veri, ad_sayfa in (("cins", cins, "Baskın Cins"),
        ...
        r = 1
        # Bu sayfalar the colleague's ozgun Bracken ciktisindan gelir; guven esigi
