...
Ali'nin klasor adlarinda F1 ve F2 yer degistirmisti.
...
def main():
    ...
    genislik(ws, [30, 104])
    ws["A1"] = "MicRhoBooster topluluk trend analizi"
    ...
    for duzey, veri, ad_sayfa in (("cins", cins, "Baskın Cins"),
        ...
        r = 1
        # Bu sayfalar Ali'nin ozgun Bracken ciktisindan gelir; guven esigi
