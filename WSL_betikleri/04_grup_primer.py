...
KONSENSÜS HANGİ KLASÖRDEN OKUNMALI (2026-08-21 düzeltmesi)
    ...
    ölçülen kayıp %100, kanıt `KAPSAMLI_ARAMA/yon_etki_testi.py`.
...
def load_engine():
    ...
    p = os.path.join(HERE, "03_primer_aday_uret.py")
    if not os.path.exists(p):
        sys.exit("03_primer_aday_uret.py ayni klasorde bulunamadi: %s" % HERE)
