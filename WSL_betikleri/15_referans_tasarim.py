...
Kullanım:
  python3 15_referans_tasarim.py --db REFERANS_DB --pt . \
...
_s27 = importlib.util.spec_from_file_location(
    "_dz", os.path.join(HERE, "27_duzey_denetimi.py"))
DZ = importlib.util.module_from_spec(_s27)
_yedek27, sys.argv = sys.argv, ["27_duzey_denetimi.py"]
try:
...
def get_args():
    ...
    p.add_argument("--pt", required=True, help="PROJECT kok klasoru")
...
def main():
    ...
    G = yukle("g04", MOTOR)
    O = yukle("o09", os.path.join(HERE, "09_ozgulluk.py"))
