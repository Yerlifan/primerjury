...
#
# Kullanım:
#   bash 07_referans_sabitle.sh --pt <PROJECT> --out <06 cikti> \
...
[ -n "$PT" ] && [ -n "$OUT" ] || {
  echo "kullanim: bash $0 --pt <PROJECT> --out <06 cikti klasoru> [--mode pin|self]" >&2
  exit 2; }
...
log "bitti"
echo
echo "Sonraki adim: 02_N_analizi.sh bu konsensusleri isleyip maske uretecek,"
echo "ardindan 04_grup_primer.py ve 05_kume_bol.py ile tasarima donulecek."
