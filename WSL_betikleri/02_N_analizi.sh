...
#   the colleague's consensus2.sh betiği samtools consensus'u iki kez çağırıyor:
...
#
# Kullanım:
#   bash 02_N_analizi.sh --pt "/path/to/your/project" \
...
[ -n "$PT" ] && [ -n "$OUT" ] || { echo "kullanim: bash $0 --pt <PROJECT> --out <cikti>" >&2; exit 2; }
