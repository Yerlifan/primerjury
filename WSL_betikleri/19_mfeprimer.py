...
14_dis_veritabani.py blastn kullanir: her primeri ayri ayri arar, sonra
...
Kullanim:
  python3 19_mfeprimer.py --final primer_final --db REFERANS_DB \
      --mfe ARACLAR/mfeprimer --out primer_final/mfeprimer.tsv
"""
...
# gosterir. Liste 14_dis_veritabani.py'deki ile BIREBIR AYNI olmak
