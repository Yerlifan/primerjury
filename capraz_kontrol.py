...
# CIDDIYET DUZEYLERI
# ===========================================================================
# KRITIK : siparisi ya da yoneticiye verilecek sayiyi DOGRUDAN yanlis yapar
...
def modul_1_kimlik(kay, rap, kn, kip=u'hizli', yalniz=None, tavan=0):
    ...
    for kb in kutular:
        ...
        # --- ad degisti mi (yoneticiye gosterilecek asil sutun)
        ...
        if ad_degisti == u'EVET':
            rap.ekle(M, u'M1-AD-DEGISTI', CIDDI,
                     ...
                     krapor or kb['yol'],
                     u'Yoneticiye gosterilecek asil satir budur: Kraken etiketi olcumle degisti.')
    ...
    for bolum, istek, durum in istekler:
        ...
        if kategoriler:
            ...
            rap.ekle(M, u'M7-KATEGORISIZ-BOSLUK', CIDDI,
                     ...
                     u'Kategorisiz bir bosluk, yoneticiye "neden olmadi" sorusuna '
                     u'cevap veremez.')
    ...
    if ciftler is not None and karar_hedefleri:
        ...
        for h in baglanmayan:
            ...
            rap.ekle(M, u'M7-PANELDE-FAZLA', UYARI,
                     ...
                     u'Yoneticiye "bu neden panelde" diye sorulursa dayanak gosterilemez.')
...
def raporla(kay, rap, cikti, kosulan, sureler):
    ...
    # ---------------- M1 kimlik tablosu ayri TSV (yoneticiye gidecek asil tablo)
    kimlik_yol = None
    ...
    if satirlar:
        ...
        L.append(u'**Adi DEGISEN kutular (%d)** - yoneticiye gosterilecek asil tablo:'
                 % len(degisen))
        L.append(u'')
        if degisen:
