...
"""
# ---------------------------------------------------------------------------
# kontrol.py — kesinti dayanikliligi: her hedefin sonucunu diske yazar ve
...
# CAGRAN : __main__.py (her hedef bitince), hepsi.py, panel_olcum.py ve
#          uyelik_denetimi.py kendi kontrol noktalarini bu modulun yollari ve
