...
Yaptigi is screening.bat menusundeki SECENEK (4)'e tasindi:
    panel_olcum.py  ->  python3 -m screening --mod panel-olc --tam-derinlik
...
Tek giris noktasi: klasor kokundeki screening.bat
"""
# ---------------------------------------------------------------------------
...
#          screening.bat tusu 4'e (panel_olcum.py, --mod panel-olc
...
import sys
print(__doc__)
sys.exit('Bu betik devre disi. screening.bat -> secenek (4) kullanin.')
