# -*- coding: utf-8 -*-
"""
yon_kod_taramasi.py - konsensus okuyan HER betigi bulur ve yonu nasil ele aldigini
...
Kullanim: python yon_kod_taramasi.py --kok .. --out ..\yon_kod_taramasi.tsv
"""
# ---------------------------------------------------------------------------
# yon_kod_taramasi.py — projedeki her .py dosyasini okuyup konsensus okuyan kod
...
#          yon_sayfasi.py ile panelin yon sayfasina islenir.
#
...
# hedefler.py ve yapilandirma.py "consensus sequences" adini yalniz aciklamada
...
def kod_govdesi(metin):
    ...
    degildir - ilk taramada bu yuzden yanlis pozitif cikti (hedefler.py,
    yapilandirma.py 'consensus sequences'i yalniz aciklamada aniyor)."""
    try:
