# -*- coding: utf-8 -*-
"""hedef_takson_esleme.py - iki tabloyu uretir:
...
"""
# ---------------------------------------------------------------------------
# hedef_takson_esleme.py — iki soruyu tabloya baglar: paneldeki her hedef hangi
#                          toplanti kararindan geliyor, ve numunedeki her takson
#                          hangi hedefin kapsamina giriyor.
#
# GIRDI  : --r2 ile olcum sonuclari deseni, --capraz ile capraz_kapsam.py'nin
...
#          Girdilerinden biri olan capraz_kapsam.py de elle calistirilir.
#
