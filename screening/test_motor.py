# -*- coding: utf-8 -*-
"""
test_motor.py - okuma_motoru.py'nin KAYIPSIZ oldugunu kanitlar.
...
Kullanim:
    python test_motor.py                          # yalniz T1 (sentetik, veri gerekmez)
    python test_motor.py "fastq files/A1-4/*.fastq" [--n 300] [--mm 1]
Cikis kodu 0 = gecti, 1 = kaldi.
"""
# ---------------------------------------------------------------------------
# test_motor.py — okuma_motoru.py'nin guvercin yuvasi tohumlamasinin KAYIPSIZ
...
#          olarak okuma_motoru.py ve kaba_kuvvet.py'yi dogrudan ice aktarir;
...
#          karsilastirmanin kucultulmus hali her kosuda kendini_sina.py
