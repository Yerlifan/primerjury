# -*- coding: utf-8 -*-
"""capraz_kapsam.py - evrensel/genis ciftleri SINIF SINIRI OLMADAN her kutuya kosar.
...
Kullanim: python capraz_kapsam.py --fastq "..\fastq files" --out capraz.json
"""
# ---------------------------------------------------------------------------
# capraz_kapsam.py — bes genis/evrensel cifti, amplikon sinifi sinirini
...
#          icinde sabit listedir. Olcumu okuma_motoru.py yapar.
...
# CAGRAN : MENUDE DEGILDIR - elle calistirilir. Ciktisi hedef_takson_esleme.py
