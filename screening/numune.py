...
#          uyelik_denetimi.calistir icinden - yani screening.bat tuslari
#          1, 2, 3, 4, 5, 7 ve 9. Disaridan protocol/tek_protokol_olc.py
#          (tus P) ve verification/kurtarma_turu.py (tus K) de ice aktarir.
# ---------------------------------------------------------------------------
