...
#          aktarir; disaridan protocol/tek_protokol_olc.py (tus P),
#          verification/kurtarma_turu.py (tus K) ve verification/dogrulama_turu.py
...
# 0 urun verir (olculen kayip %100 - screening/yon_etki_testi.py).
# Kanonik klasor screening/kanonik_uret.py ile uretilir. Tanim: yon.py
...
# Cekirdek motor modulleri (ispcr, okuma, tarayici, cift). screening/motor.py
