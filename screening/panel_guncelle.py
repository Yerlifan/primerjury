...
def sayfa16(wb, rows):
    ...
    for s in [
        ...
        'KAYIPSIZLIK KANITLANDI: screening/test_motor.py duzeltilmis motoru, tohum kullanmayan ve her '
        ...
        'DOSYALAR: screening/okuma_motoru.py (motor), kaba_kuvvet.py (referans), test_motor.py (kanit), '
    ...
    for s in [
        ...
        'Kosmak icin: python screening/bagimsiz_dogrulama.py --fastq "fastq files"',
    ]:
        yaz(ws, n, 1, s); ws.merge_cells(start_row=n, start_column=1, end_row=n, end_column=9)
        ws.row_dimensions[n].height = 46; n += 1
    n += 1
