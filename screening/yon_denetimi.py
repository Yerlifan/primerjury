# -*- coding: utf-8 -*-
"""
yon_denetimi.py - her konsensus dosyasinin SAKLANDIGI YONU tespit eder.

Neden gerek: yon hatasi gece boyunca EN AZ UC AYRI YERDE ayri ayri bulunup ayri ayri
yamandi (SRC'de 85'in iplik secimi, tasarim tarafinda "konsensusler SILVA'ya gore ters",
...
Kullanim:
    python yon_denetimi.py --kok ..  --out ..\yon_denetimi_20260802.tsv
    python yon_denetimi.py --kok .. --klasor "consensus sequences"
"""
# ---------------------------------------------------------------------------
# yon_denetimi.py — bir konsensus klasorundeki HER dosyanin saklandigi yonu iki
...
#          yon_sayfasi.py ile panele "19 Yon Normalizasyonu" sayfasi olarak
#          islenir. Kanonik uretimin kendisi kanonik_uret.py'de yapilir.
#
