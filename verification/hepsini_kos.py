...
#
# GİRDİ  : ASAMALAR tablosundaki dort betik (protocol/tek_protokol_olc.py,
#          verification/kurtarma_turu.py, verification/dogrulama_turu.py,
#          verification/kimlik_dogrulama.py) ve onlarin urettigi TSV dosyalari;
...
# ÇAĞRAN : screening.bat -> T tusu
#          (bat icinde: wsl -e python3 "verification/hepsini_kos.py" --kok .)
#
...
ASAMALAR = [
    ('P', u'TEK PROTOKOL - panelin tamami tek kuralla olculur',
     ['protocol/tek_protokol_olc.py'], 'TEK_PROTOKOL_SONUC/panel_tek_protokol.tsv',
     u'1-2 saat'),
    ('K', u'verification - esik alti satirlar dort yolla kurtarilir',
     ['verification/kurtarma_turu.py'], 'KURTARMA_SONUC/kurtarma_satirlari.tsv',
     u'1-3 saat'),
    ('D', u'DOGRULAMA - kurtarilan ciftler uc katmanla sinanir',
     ['verification/dogrulama_turu.py'], 'DOGRULAMA_SONUC/dogrulama_uc_sutun.tsv',
     u'1-4 saat'),
    ('I', u'KIMLIK DOGRULAMA - rapora giren iddialar bagimsiz sinanir',
     ['verification/kimlik_dogrulama.py'], 'KIMLIK_SONUC/kimlik_iddialari.tsv',
     u'3-7 saat'),
]
