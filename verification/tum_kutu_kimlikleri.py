...
#          konsensus_kanonik/ ve panel + uyelik tablolari (screening.hedefler),
...
# ÇAĞRAN : screening.bat -> G tusu
#          (bat icinde: wsl -e python3 "verification/tum_kutu_kimlikleri.py" --kok .)
#
