...
Kosum:
    python verification/geometri_yenile.py --kok .
    python verification/geometri_yenile.py --kok . --yaz     (panel tablosunu da guncelle)
"""
    ...
    for aday in ('DUZELTME_betikleri', 'MADDE123_betikleri'):
        ...
        if os.path.exists(os.path.join(d, 'geo.py')):
            ...
            try:
                ...
                return None, (u'geo.py bulundu (%s) ama yuklenemedi: %s\n'
