# -*- coding: utf-8 -*-
"""
hizalayici_minimap2.py - kimlik asamasi icin IKINCI, SECILEBILIR hizalayici.

Bu dosya mevcut motoru DEGISTIRMEZ, yanina durur. kimlik_dogrulama.py icindeki
...
# CAGRAN : verification/kimlik_dogrulama.py (I tusu) ve verification/tum_kutu_kimlikleri.py
...
#     kacirir. Orada guvercin yuvasi motoru (screening/okuma_motoru.py)
