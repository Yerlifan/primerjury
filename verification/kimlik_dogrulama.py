...
# -------------------------------------------------------------------------
# kimlik_dogrulama.py — raporlanan kimlik iddialarini dis referans
...
#          konsensus_kanonik/ (screening.hedefler.konsensusler ile),
...
# ÇAĞRAN : screening.bat -> I tusu
#          (bat icinde: wsl -e python3 "verification/kimlik_dogrulama.py" --kok .)
...
def elle_nt_girdi(kutu, q, CIKTI, yaz):
    ...
    if not os.path.exists(sab):
        with open(sab, 'w', encoding='utf-8', newline='') as fh:
            ...
            fh.write(u'#   python3 verification/kimlik_dogrulama.py --kok . '
...
#     screening/dislama_kapsama_denetimi.py:103
#     screening/siparis_siniflari.py:200
# ve verification/ncbi_katman4.py docstring'i adsiz klonlarin dislama suzgecine
...
def _en_yakin_etiket(isabet):
    ...
    if not tam:
        return '?'
    # Taksonomi tasiyor mu? screening/taksonomi.py ile cozulur - bes ayri
    ...
    try:
        ...
        from screening import taksonomi as _TX
