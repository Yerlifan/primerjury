...
--- ozgun aciklama ---
full_chain.py - bastan sona TEK SECENEKLE kosan tam zincir surucusu.
...
"""
# ---------------------------------------------------------------------------
# full_chain.py - verification/full_chain.py menusundeki A tusunun motoru.
#
...
# CAGRAN : verification/full_chain.py -> A tusu
#          (bat icinde: wsl -e python3 "verification/full_chain.py" --kok . --onayla)
#
