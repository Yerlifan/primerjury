# ---------------------------------------------------------------------------
# geo.py — paneldeki 21 hedefin 42 primerinin qPCR GEOMETRI denetimi; her primer
...
#          basar.
# ÇAĞRAN : screening/kendini_sina.py bu dosyayi AYRI BIR SUREC olarak
#          gecici bir dizinde calistirir, urettigi geo.json'u okur ve
#          screening/geometri.py'nin ayni 42 primer icin verdigi
...
#          sinama her olcum tusunun basinda kosar: screening.bat tuslari
#          1, 2, 3, 4, 5, 6, 7, 9 ve dogrudan tus 8. Dosya menuden DOGRUDAN
#          cagrilmaz; referans/altin standart olarak durur.
#
# ÖLÇÜLDÜ - HANGI KOPYA CALISIYOR: kendini_sina.py, yapilandirma.BETIK_YOLLARI
# sirasini gezip ILK buldugu geo.py'yi alir. Sira engine,
# engine, engine'dir ve engine'nde geo.py
# YOKTUR; dolayisiyla fiilen engine/geo.py calistirilir. Bu dosya
...
# screening/geometri.py ile karsilastirilabilir bir altin standart olur.
P = [
...
# karisimini (QuantiNova SYBR Green) temsil eder; yapilandirma.py'de ayni
# degerler P3 sabitinde "geo.py ile birebir" notuyla tekrarlanmistir. Bu
...
# Sonucu:
#   1) geo.py'yi import eden her betik, ekrana yukaridaki P listesinin (2
...
# kendini_sina.py bu dosyayi AYRI BIR SUREC olarak (cwd=gecici dizin)
...
if __name__ == "__main__":
    ...
    # geo.json CALISILAN DIZINE yazilir (mutlak yol yok). kendini_sina.py bu dosyayi
