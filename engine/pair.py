...
# ---------------------------------------------------------------------------
# pair.py — binlerce aday primer ciftini ham okumalara karsi hizli taramak icin
...
# ÇAĞRAN : screening/engine_gateway.py bu dosyayi ada gore bulup yukler (zorunlu
#          degil; yoksa cift=None kalir) ve self_test.py yuklendigini
#          dogrular. Ayni klasordeki son_sec.py, nd_v2/v2b/v3/v4.py, match.py,
#          arke_esle.py, arke_skor.py, clo_ara.py, clo_ara2.py,
#          dogrula_cift.py "from cift import urunler" der. Menude engine_gateway.py
