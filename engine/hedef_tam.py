...
from screening import hedefler as H, motor, uretec as U, numune as N
import importlib.util as _iu
_sp = _iu.spec_from_file_location('kt', os.path.join(KOK, 'verification', 'kurtarma_turu.py'))
...
def main():
    ...
    ap.add_argument('--sure', type=float, default=150.0)
    ap.add_argument('--durum', default='')
    ap.add_argument('--primer-ust', type=int, default=1100)
    ap.add_argument('--pencere-aday', type=int, default=6)
    ap.add_argument('--arms-ust', type=int, default=8)
    ap.add_argument('--sig', type=int, default=900)
    ap.add_argument('--derin', type=int, default=3000)
    ap.add_argument('--asama', default='tara', choices=['tara', 'derin'])
    ap.add_argument('--uye-taxid', default='', help='uyeligi ELLE ver (virgullu)')
    ap.add_argument('--rakip-taxid', default='', help='rakipleri ELLE ver')
    ap.add_argument('--sinif', default='', help='kutu sinifi suzgeci, or. F2')
    ap.add_argument('--omurga', default='',
    ...
    # Yoneticinin listesindeki taksonlarin cogunun panelde karsiligi yok; eskiden
    ...
    if a.uye_taxid:
        ...
        # Bu yol screening/hedefler.py icindeki KUTU: yolunun aynisidir.
