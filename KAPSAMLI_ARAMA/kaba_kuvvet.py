# -*- coding: utf-8 -*-
"""
kaba_kuvvet.py - BAGIMSIZ referans uygulama. Tohum YOK, kisayol YOK.

Her baslangic pozisyonu tek tek denenir. Yavastir; amaci hizli olmak degil,
`okuma_motoru.py`'nin dogrulugunu sinayacak, ondan BAGIMSIZ bir dogru cevap
uretmektir. Ortak kod paylasmaz - IUPAC tablosu ve ters tumleyen bile ayrica
yazilmistir ki ikisinde ayni hata olmasin.

Kullanim: test_motor.py tarafindan cagrilir.
"""
# ---------------------------------------------------------------------------
# kaba_kuvvet.py — okuma_motoru.py'nin dogrulugunu sinamak icin yazilmis,
#                  tohumsuz ve kisayolsuz referans uygulama.
#
# GIRDI  : dogrudan dizi ve primer alir; dosya okumaz. Cagiran taraf okumalari
#          verir (test_motor.py, kendini_sina.py ya da bagimsiz_dogrulama.py).
# CIKTI  : dosyaya yazmaz. yerler() [(baslangic, uyumsuzluk)] listesi,
#          urun_boyu() urun boyu ya da None, kutu_pcr() (urun_veren, toplam)
#          ikilisi dondurur.
# CAGRAN : test_motor.py ve bagimsiz_dogrulama.py (elle calistirilan sinamalar)
#          ile motor.py uzerinden kendini_sina.py - yani KAPSAMLI_ARAMA.bat
