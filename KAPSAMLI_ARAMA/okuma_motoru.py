# -*- coding: utf-8 -*-
r"""
okuma_motoru.py - DUZELTILMIS ham-okuma in-silico PCR motoru.
2026-08-02, okuma motoru duzeltmesi.

BAGIMSIZDIR: numpy, ispcr, okuma.py, pysam, minimap2 GEREKMEZ. Saf standart Python.
...
KAYIPSIZLIK IDDIASI TEST EDILMISTIR: test_motor.py bu motoru, tohum kullanmayan
ve her pozisyonu tek tek deneyen bagimsiz bir kaba kuvvet uygulamasiyla
(kaba_kuvvet.py) karsilastirir. Panele girmeden once o testi kosun.
...
Komut satirindan (.bat icin):
    python okuma_motoru.py F_PRIMER R_PRIMER [--mm 1] [--lo 40] [--hi 600]
    ...
    Ornek:
      python okuma_motoru.py GCCCTTGGGACCGGCATAA TCGCTGGCTAGTAGGTACATTACA ^
...
"""
# ---------------------------------------------------------------------------
# okuma_motoru.py — ham nanopore okumalari uzerinde in-silico PCR yapan
...
# CAGRAN : Paket ici: motor.py bu dosyayi ice aktarir, numune.KutuOtorite ve
#          numune.KutuEski uzerinden butun olcum asamalarinda kullanilir - yani
#          KAPSAMLI_ARAMA.bat tuslari 1, 2, 3, 4, 5, 6, 7, 8, 9. Ayrica yon.py,
#          yon_denetimi.py, yon_etki_testi.py, capraz_kapsam.py, test_motor.py
#          ve bagimsiz_dogrulama.py dogrudan ice aktarir.
# ---------------------------------------------------------------------------
...
class Sonda:
    ...
    def __init__(self, primer, uc5=False, max_mm=1, son2=True):
        ...
        # Kayipsizlik iddiasi test_motor.py'de kaba_kuvvet.py'ye karsi
        # dogrulanir; kendini_sina.py her kosuda ayni karsilastirmayi yapar.
        # ------------------------------------------------------------------
