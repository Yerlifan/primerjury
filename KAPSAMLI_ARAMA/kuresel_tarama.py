...
"""
# ---------------------------------------------------------------------------
# kuresel_tarama.py — hayatta kalan son adaylari REFERANS_DB'deki tam
...
#          dondurur.
# CAGRAN : __main__.hedefi_isle icinde asama E - yani KAPSAMLI_ARAMA.bat
#          tuslari 1, 2, 3, 7 ve 9'un 7. asamasi (--hafif verilirse atlanir).
#          Disaridan KURTARMA/dogrulama_turu.py (tus D) AYNEN bu modulu
