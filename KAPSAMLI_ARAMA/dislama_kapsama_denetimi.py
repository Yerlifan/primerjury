...
Kosum:
    python KAPSAMLI_ARAMA/dislama_kapsama_denetimi.py --kok .
...
def main():
    ...
    uy = os.path.join(kok, 'KAPSAMLI_ARAMA', 'hedef_uyelik.tsv')
    for f in (hy, uy):
    ...
    IST = {}
    iy = os.path.join(kok, 'KAPSAMLI_ARAMA', 'kapsama_istisna.tsv')
    ...
    ESD = {}
    ey = os.path.join(kok, 'KAPSAMLI_ARAMA', 'kimlik_taxid_esdegeri.tsv')
