# -*- coding: utf-8 -*-
"""
yon_etki_testi.py - BILINEN CEVAPLI TEST: yonun yanlis olmasi hangi sayiyi ne kadar bozar.
...
Kullanim: python yon_etki_testi.py --kok ..
"""
# ---------------------------------------------------------------------------
# yon_etki_testi.py — "yon yanlissa ne kaybederiz" sorusunu sayiya baglar:
...
#          sayi (dogru yonde 117 urun, ters yonde 0) yapilandirma.py ve yon.py
