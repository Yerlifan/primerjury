# -*- coding: utf-8 -*-
"""
siparis_ve_durum.py - iki teslim dosyasi uretir, CANLI panelden:
...
"""
# ---------------------------------------------------------------------------
# siparis_ve_durum.py — canli panelden iki teslim dosyasi uretir: siparis
...
#          (P) tusu ayri bir siparis listesi uretir (TEK_PROTOKOL klasorunde) ve
#          bu betigi kullanmaz.
#
