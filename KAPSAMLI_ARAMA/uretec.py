...
"""
# ---------------------------------------------------------------------------
# uretec.py — aday primer ve aday cift ureteci; 144 hucreli parametre
...
#          uye konsensusu); yapilandirma.py'deki UZUNLUK, URUN_IDEAL,
...
#          KAPSAMLI_ARAMA.bat tuslari 1, 2, 3, 7 ve 9 (7. asama). Ayrica
#          KURTARMA/kurtarma_turu.py (tus K) bu modulu disaridan ice aktarir.
# ---------------------------------------------------------------------------
import itertools
...
def arms_varyantlari(primer):
    ...
    # 15 varyant uretilir; kendini_sina.py bu sayiyi her kosuda dogrular.
    if len(primer) < 4:
        return []
    out = []
    p = list(primer)
