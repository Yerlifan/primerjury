...
panel_guncelle.py - okuma motoru duzeltmesini panele isler.
  ...
  * "1 Hocaya Ozet" ve "6 Karar Durumu": degisen satirlar ve uyari
  * hocaya_ozet TSV'si senkron

Kullanim: python panel_guncelle.py --xlsx ..\MicRhoBooster_PCR_Paneli_2026-08-02_TESLIM.xlsx
...
#          alir; ayrica hocaya_ozet TSV'sini senkronlar. Ekrana guncellenen
