...
"""
# ---------------------------------------------------------------------------
# numune.py — kutu basina ham okuma havuzlarini kurar ve bir primer cifti icin
...
#          yolu); yapilandirma.py'deki NUMUNE_OKUMA_MIN/MAX, NUMUNE_OKUMA_SAYISI,
#          NUMUNE_TOHUM, NUMUNE_MAX_MM, KAPSAM_ESIGI, ENKOTU_ASGARI_OKUMA;
#          olcum motorlari motor.py uzerinden (okuma_motoru, tarayici.Havuz,
...
#          uyelik_denetimi.calistir icinden - yani KAPSAMLI_ARAMA.bat tuslari
#          1, 2, 3, 4, 5, 7 ve 9. Disaridan TEK_PROTOKOL/tek_protokol_olc.py
#          (tus P) ve KURTARMA/kurtarma_turu.py (tus K) de ice aktarir.
# ---------------------------------------------------------------------------
...
class KutuOtorite:
    """DUZELTILMIS motorla (okuma_motoru.py) olcum - OTORITE yol.

    Guvercin yuvasi tohumlamasi kayipsizdir ve kaba_kuvvet.py ile birebir
...
class KutuEski:
    ...
    okuma.py/Sonda'nin 13 bazlik TAM eslesen tohumu burada birebir yeniden
...
class Numune:
    """otorite=True -> okuma_motoru.py (kayipsiz, yavas; panel yeniden olcumu)
