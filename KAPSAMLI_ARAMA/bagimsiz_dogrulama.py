...
bagimsiz_dogrulama.py - Baslik sayilarini UC AYRI yolla olcup tuttugunu gosterir.
  ...
  Yol C  okuma_motoru.py              : bu oturumda duzeltilen motor (referans).
...
Kullanim:
    python bagimsiz_dogrulama.py --fastq "..\fastq files" [--mm 1] [--nmax 3000]
"""
# ---------------------------------------------------------------------------
# bagimsiz_dogrulama.py — teslim basliklarindaki sayilari uc ayri kod yoluyla
